                ...
                <div className="login-main login-tab">
                    ...
                    <TabContent activeTab={selected} className="content-login">
                        ...
                        <Form className="theme-form">
                            ...
                            <h4>{selected === "firebase" ? "Логин с Firebase" : "Логин с Jwt"}</h4>
                            ...
                            <FormGroup>
                                ...
                                <FormFeedback>{"Пожалуйста, введите пароль."}</FormFeedback>
                            ...
                            <FormGroup className="mb-0">
                                ...
                                {selected === "firebase" ?
                                    <Button color="primary" onClick={() => SubmitForm(user.email,user.password)}>Войти</Button>
                                    :
                            ...
                            <p className="mt-4 mb-0">{"Ещё нет аккаунта?"}<a className="ms-2" href="#javascript">Создать</a></p>
