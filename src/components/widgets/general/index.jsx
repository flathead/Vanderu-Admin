      ...
      {clients && cartProducts && employeeStatus ?
        <Container fluid={true}>
          <Row>
                ...
                <Row>
                  ...
                  <Col sm="6" className="ps-0">
                    <div className="media">
                      ...
                      <div className="media-body align-self-center ps-3"><ArrowUp className="font-primary" /></div>
                      <div className="media-body ps-2">
                ...
                <Row>
                  <Col sm="6" className="pe-0">
                    <div className="media border-after-xs">
                      ...
                      <div className="media-body align-self-center"><ShoppingBag className="font-primary float-start ms-2" /></div>
                    </div>
                  </Col>
                  <Col sm="6" className="ps-0">
                    <div className="media">
                      <div className="align-self-center me-3 digits">{"12%"}<i className="fa fa-angle-down ms-2"></i></div>
                      ...
                      <div className="media-body align-self-center"><Layers className="font-primary float-start ms-3" /></div>
                    </div>
                  </Col>
                  <Col sm="6" className="pe-0">
                    <div className="media border-after-xs">
                      ...
                      <div className="media-body align-self-center"><ShoppingCart className="font-primary float-start ms-2" /></div>
                    </div>
                  </Col>
                  <Col sm="6" className="ps-0">
                    <div className="media">
                      ...
                      <div className="media-body align-self-center"><DollarSign className="font-primary float-start ms-2" /></div>
                    </div>
                  </Col>
                </Row>
              </Card>
                  ...
                  <Row>
                    ...
                    <Col xl="6" xs="12" md="6" sm="6">
                      <div className="cal-datepicker">
                        <div className="datepicker-here float-sm-end" data-language="ru">
                          <DatePicker
                            selected={startDate}
                ...
                <Card>
                  ...
                  <CardBody>
                    <ul className="crm-activity">
                      ...
                      <li className="media"><span className="me-3 font-secondary">{"A"}</span>
                        <div className="align-self-center media-body">
                      ...
                      <li className="media"><span className="me-3 font-primary">{"H"}</span>
                        <div className="align-self-center media-body">
                  ...
                  <Row>
                    ...
                    <Col xs="6">
                      <div className="text-md-end">
                        <ul>
                          <li>{Profit}<span className="product-stts font-primary ms-2">{"8989"}<i className="icon-angle-up f-12 ms-1"></i></span></li>
                          <li>{Loss}<span className="product-stts font-primary ms-2">{"2560"}<i className="icon-angle-down f-12 ms-1"></i></span></li>
                        </ul>
                      </div>
                    </Col>
                  </Row>
            ...
            <Col sm="6" xl="3" lg="6" className="xl-50 box-col-3">
                      ...
                      <tbody>
                        {cartProducts.map(data => (
                          <tr key={data.details}>
                            ...
                            <td>
                              <div className={`span badge rounded-pill ${data.className}`}>{data.price}</div></td>
                          </tr>
                        ))}
                      </tbody>
                    </Table>
              ...
              <Card className="height-equal">
                ...
                <CardBody className="contact-form">
                  <Form className="theme-form">
                    <div className="form-icon"><i className="icofont icofont-envelope-open font-primary"></i></div>
                    <FormGroup>
