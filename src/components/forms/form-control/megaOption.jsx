...
const MegaOption = (props) => {
  return (
    <Fragment>
      ...
      <Container fluid={true} className="mega-option">
        <Row>
                    ...
                    <Col sm="6">
                      <Card>
                        <Media className="p-20">
                          ...
                          <Media body>
                            <h6 className="mt-0 mega-title-badge">{COD}<span className="badge bg-primary pull-right digits">{"50 INR"}</span></h6>
                    ...
                    <Col sm="6">
                      <Card>
                        <Media className="p-20">
                          ...
                          <Media body>
                            <h6 className="mt-0 mega-title-badge">{Local} <span className="badge bg-primary pull-right digits">{Free}</span></h6>
