...
export const apexAreaChart = {
  ...
  weekSeries: [{
    name: "Доход",
    data: weekSeries.weekDataSeries1.prices
  }],
  options: {
    chart: {
      type: 'area',
    ...
    subtitle: {
      text: 'График за текущее количество календарный дней месяца',
      align: 'left'
    },
    colors: [primary],
  ...
  weekOptions: {
    ...
    title: {
      text: 'Доход за последнюю неделю',
      align: 'left'
    },
    subtitle: {
      text: 'График за последние 7 календарных дней',
      align: 'left'
    },
    colors: [primary],
    labels: weekSeries.weekDataSeries1.dates,
    xaxis: {
      type: 'datetime',
    },
    yaxis: {
