...
import { Container, Row, Col, Card, CardBody, Form, FormGroup, Label, Input, Button, Badge, Table, CardHeader } from 'reactstrap'
        	...
        	<Col xs="12" md="8">
		        ...
		        <Col sm="12">
		          <Card>
		            ...
		            <ProgressBar
		              percent={percentage}
		              filledBackground="linear-gradient(to right, rgb(115 102 255), rgb(68 51 255))"
		            >
		              <Step transition="scale">
		                {({ accomplished }) => (
		                  <div className="progress-icon">
		                    <img
		                      style={{ filter: `grayscale(${accomplished ? 0 : 80}%)`, borderRadius: '50%', background: '#ffffff' }}
		                      width="40"
		            ...
		            <Card>
		              <CardBody>
		                <Form className="theme-form" onChange={formChange} onSubmit={handleSubmit(AddProject)}>
		                  ...
		                  <Row ref={ref} className="form-row mb-4">
		                    <Col>
		                      <FormGroup>
		                  ...
		                  <Row>
		                    ...
		                    <Col sm="12" className="mb-4 d-flex align-items-center justify-content-start">
