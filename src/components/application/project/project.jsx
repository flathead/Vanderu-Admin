...
import { All, Doing, CreateNewProject, OnPause, InArchive, TodaySubs, MonthSubs, ActiveSubs } from '../../../constant'
...
const Project = () => {
  ...
  /* const pauseProject = useSelector(content => content.Projectapp.pause_Project);
  const archiveProject = useSelector(content => content.Projectapp.archive_Project); */
              ...
              <Row>
                <Col md="6">
                  <Nav tabs className="border-tab">
                    ...
                    <NavItem><NavLink className={activeTab === "2" ? "active" : ''} onClick={() => setActiveTab("2")}><CheckCircle />{Doing}</NavLink></NavItem>
                    <NavItem><NavLink className={activeTab === "2" ? "active" : ''} onClick={() => setActiveTab("3")}><Archive />{InArchive}</NavLink></NavItem>
                    <NavItem><NavLink className={activeTab === "3" ? "active" : ''} onClick={() => setActiveTab("4")}><Pause />{OnPause}</NavLink></NavItem>
                  </Nav>
                </Col>
                <Col md="6">
