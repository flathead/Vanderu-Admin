                                            ...
                                            <div className="media">
                                                ...
                                                <div className="about">
                                                    <Link to={`${process.env.PUBLIC_URL}/app/users/userProfile/${layout}`}>
                                                        <div className="name f-w-600">{currentUser.name}</div></Link>
                                                                ...
                                                                <li key={index} className="clearfix">
                                                                    <div className={`message my-message ${item.sender !== currentUser.id ? '' : 'float-end'}`}>
                                                                        <Media src={dynamicImage(participators.thumb)}
                                                                            className={`rounded-circle ${item.sender !== currentUser.id ? 'float-start' : 'float-end'} chat-user-img img-30`} alt="" />
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Col xl="12" className="d-flex">
                                                            ...
                                                            <InputGroup className="text-box">
                                                                ...
                                                                />
                                                                <Button className="input-group-text" color="primary" onClick={() => handleMessagePress('send')} >{Send}</Button>
                                                            </InputGroup>
                                                        </Col>
                                                    </Row>
                                                </div>
                                            ...
                                            <TabContent activeTab={activeTab}>
                                                ...
                                                <TabPane tabId="2">
                                                    ...
                                                    <div className="status">
                                                        ...
                                                        <hr />
                                                        <p>{ChataApp_p2}<i className="icofont icofont-emo-rolling-eyes font-success f-20 m-l-5"></i></p>
                                                    </div>
                                                </TabPane>
                                                <TabPane tabId="3">
                                                    <div className="user-profile">
                                                        ...
                                                        <div className="user-content text-center">
                                                            ...
                                                            <div className="follow text-center">
                                                                <Row>
                                                                    <Col className="border-end"><span>{Following}</span>
