...
export const routes = [
        ...
        { path: `${process.env.PUBLIC_URL}/app/pay/:layout`, Component: <Pay /> },
        { path: `${process.env.PUBLIC_URL}/app/project/inside/:layout`, Component: <InsideProject /> },
        { path: `${process.env.PUBLIC_URL}/app/statistic/:layout`, Component: <Statistic /> },
        { path: `${process.env.PUBLIC_URL}/app/tariffs/tariffs/:layout`, Component: <Tariffs /> },
        ...
        { path: `${process.env.PUBLIC_URL}/app/support/:layout`, Component: <Support /> },
        { path: `${process.env.PUBLIC_URL}/app/support-ticket/:layout`, Component: <SupportTicket /> },


        { path: `${process.env.PUBLIC_URL}/app/partnership/:layout`, Component: <Partnership /> },
        ...
        { path: `${process.env.PUBLIC_URL}/app/spam/:layout`, Component: <Spam /> },
