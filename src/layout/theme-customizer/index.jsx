...
import { Nav, NavLink, TabContent, TabPane, Button, Modal, ModalHeader, ModalBody, ModalFooter,  Media } from 'reactstrap'
import { useDispatch, useSelector } from 'react-redux'
import { CopyToClipboard } from 'react-copy-to-clipboard';
import { toast } from 'react-toastify';
import { useNavigate } from "react-router-dom";
import { Configuration, ModalTitle, CopyText, Cancel, LayoutType, LTR, RTL, Box, SidebarType, SidebarSettings, Default, Border, IconColor,  MixLayout,  UnlimitedColor, QuickOption, BuyNow, Support, CheckFeatures, Document, Apply } from '../../constant'
import {
    ADD_LAYOUT,
    ADD_SIDEBAR_TYPES,
...
const Themecustomizer = (props) => {
    ...
    useEffect(() => {
        ...
        const modifyURL = window.location.pathname + Object.keys(defaultLayoutObj).pop()

        // fetch id from URL
        const id = window.location.pathname === '/' ? history(modifyURL) : window.location.pathname.split('/').pop()
    ...
    const handleSidebarSetting = (e, type) => {
        ...
        e.currentTarget.classList.add('active');
        dispatch({ type: ADD_SIDEBAR_SETTINGS, payload: type })
        ...
        <Fragment>
            <div className="customizer-links">
                <Nav className="flex-column nac-pills">
                    ...
                    <a className="nav-link" href="https://docs.pixelstrap.com/cuba/document/index.html">
                                        ...
                                        <div className="body">
                                            <ul>
                                                ...
                                                <li className="bg-light body">
                                                    <span className="badge bg-primary">{LTR}</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li className={`${layout_type === 'rtl' ? 'active' : ''}`} onClick={() => handleLayout('rtl')}>
                                        ...
                                        <div className="body">
                                            <ul>
                                                <li className="bg-light sidebar"></li>
                                                <li className="bg-light body">
                                                    <span className="badge bg-primary">{RTL}</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                        ...
                                        <li className={`${layout_type === 'box-layout' ? 'active' : ''}`} onClick={() => handleLayout('box-layout')}>
                                            ...
                                            <div className="body">
                                                <ul>
                                                    <li className="bg-light sidebar"></li>
                                                    <li className="bg-light body">
                                                        <span className="badge bg-primary">{Box}</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
