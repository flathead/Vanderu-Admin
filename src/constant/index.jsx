...
export const Done = "Завершенные"
export const Doing = "Активные"
export const InArchive = "В архиве"
export const OnPause = "На паузе"
...
export const Daily = "Сегодня"
export const Weekly = "Неделя"
export const Yearly = "Год"
export const Monthly = "Месяц"
export const AllTime = "Всё время"
...
export const CashBalance = "Подписчики"
export const SalesForcasting = "Доход"
...
export const CreateNewProject = "Создать новый проект"
...
export const TodaySubs = "Сегодня"
export const MonthSubs = "Месяц"
export const ActiveSubs = "Активных подписок"
...
export const CreditCard = "Кредитная карта"
export const DebitCard = "Дебетовая карта"
...
export const Recent = "Последние"
export const Recovery = "Recovery"
export const Deleteds = "Удаленные"
export const Storage = "Хранилище"
export const PricingPlan = "Прайс"
export const TrialVersion = "Пробная версия"
export const FREE = "БЕСПЛАТНО"
export const Free = "Бесплатно"
export const Selected = "Selected"
export const AddNew = "Добавить новый"
export const Upload = "Загрузить"
export const AllFiles = "Все файлы"
export const RecentlyOpenedFiles = "Недавно открытые файлы"
export const Folders = "Папки"
...
// bookmark
export const NewBookmark = "Новая закладка"
export const AddBookmark = "Добавить закладку"
export const EditBookmark = "Редактировать закладку"
export const MyBookmark = " Моя закладка"
export const WebUrl = "Ссылка"
export const Title = "Заголовок"
export const Description = "Описание"
export const Group = "Группа"
export const Collection = "Коллекция"
export const General = "General"
export const MyBookmarks = "Мои закладки"
export const Views = "Просмотры"
export const CreatedByMe = "Создано мной"
export const Favourites = "Избранные"
export const SharedWithMe = "Shared with me"
export const Tags = "Тэги"
export const Newsletter = "Новостная лента"
export const Holidays = "Праздники"
export const Important = "Важное"
export const Orgenization = "Организация"
export const NoBookmarksFound = "Закладок не найдено."
...
export const ExtraextraLarge = "Extra extra large"
...
export const ColoredRibbons = "Colored Ribbons"
...
export const AreaSplineChart = "Area Spline Chart"
